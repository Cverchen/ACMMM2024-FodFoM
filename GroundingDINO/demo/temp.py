...
def plot_boxes_to_image(flag, image_pil, tgt, per_image_path):
    ...
    for box, label in zip(boxes, labels):
        ...
        if area/image_area <= 1:#当检测出来的区域与整体图像区域的占比在0.5以下
...
if __name__ == "__main__":
    ...
    #     print(classindex)
    image_path = 'Datasets/ImageNet100/train/n01530575/n01530575_2091.JPEG'
    output_dir = 'temp'
    text_prompt = 'Brambling'
    # for per_image_path in tqdm(image_path):
    per_image_path = image_path
    # make dir[]
    ...
    if flag:
        ...
        cv2.imwrite(os.path.join(output_dir,"clip.jpg"), image_clip)
    # if image_clip != None:
